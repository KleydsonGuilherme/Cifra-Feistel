...
f1 = Shift_Left(exor(R1,K1), n_shift) 
R2 = exor(f1,L1) 
L2 = R1 
   
f2 = Shift_Left(exor(R2,K1), n_shift)
R3 = exor(f2,L2) 
L3 = R2 
...
print('\nTexto plano em binario:   ', Serializar_Binario(texto_plano_Bin))
print('Criptografado em binario: ', Serializar_Binario(bin_data))
...
f3 = Shift_Left(exor(L2,K1), n_shift)
L1 = exor(R2,f3) 
R1 = L2 
   
f4 = Shift_Left(exor(L1,K1), n_shift) 
L0 = exor(R1,f4) 
R0 = L1 
